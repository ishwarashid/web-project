            ...
            <div id="wrapper">
                    ...
                    <div class="hero-title-wrap fl-wrap">
                        <div class="container">
                            <div class="hero-title">
                                ...
                                <a href="#sec3" class="hero_btn custom-scroll-link">Check out our Menu <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--hero_promo-wrap-->
                ...
                <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="text-block ">
                                        ...
                                        <a href="#sec3" class="btn fl-btn custom-scroll-link">Explore Our Menu<i class="fal fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <section class="parallax-section dark-bg hidden-section" data-scrollax-parent="true">
                        <div class="brush-dec2"></div>
                        <div class="brush-dec"></div>
                        <div class="bg par-elem bg_tabs"  data-bg="images/bg/14.jpg" data-scrollax="properties: { translateY: '30%' }"></div>
                        <div class="overlay"></div>
                        <div class="container">
                            <!-- inline-facts -->
                        ...
                        <div class="container">
                            ...
                            <div class="gallery-items min-pad  lightgallery three-column fl-wrap" style="margin-bottom:50px;">
                                ...
                                <div class="gallery-item gallery-item-second dishes">
                                    <div class="grid-item-holder hov_zoom">
                                        <a href="images/all/2.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                    ...
                    <section class="hidden-section con-sec big-padding" data-scrollax-parent="true">
                        <div class="container">
                            <div class="row">
                                        ...
                                        <form  class="custom-form" action="https://restabook.kwst.net/light/php/contact.php" name="contactform" id="contactform">
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class=" fl-wrap">
                                                            <select name="persons" id="subject2" class="chosen-select no-search-select">
                                ...
                                <div class="col-md-4">
                                    <img src="images/all/22.jpg"  class="respimg"  alt="">
                                </div>
                            </div>
                        </div>
                        <div class="section-bg">
