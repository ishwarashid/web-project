                    ...
                    <div class="hero-title-wrap fl-wrap">
                        <div class="container">
                            <div class="hero-title">
                                ...
                                <h2>Welcome to Culinary Cove Restaurant</h2>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="text-block ">
                                        <p>
                                            Established with a passion for creating memorable dining moments, Culinary Cove was founded by a team of culinary enthusiasts who envisioned a space where exceptional cuisine meets exceptional service. Our journey began with a simple goal: to craft a haven where food aficionados could savor the finest dishes prepared with care, expertise, and a sprinkle of creativity.
                                        </p>
                                        <p> 
                                            At Culinary Cove, we are committed to providing not just a meal but a symphony of taste, quality, and exceptional service. Your satisfaction is our priority, and we aim to exceed your expectations with every visit.
                                        </p>
                    ...
                    <section class="column-section no-padding hidden-section" data-scrollax-parent="true" id="sec4">
                        <div class="column-wrap-bg left-wrap">
                            ...
                            <div class="quote-box">
                                ...
                                <p>
                                    "At Culinary Cove, we believe that each dish is a canvas where passion meets innovation. Our commitment lies in crafting culinary symphonies that not only tantalize taste buds but also evoke emotions. Every ingredient, every spice, and every technique is a stroke in the masterpiece of flavors we create. We invite you to join us on a journey where each bite tells a story and where the essence of culinary artistry meets the warmth of hospitality."
                                </p>
                                            ...
                                            <div class="content-back">
                                                <div class="cf-inner">
                                                    <div class="inner">
                                                        ...
                                                        <p>Our commitment to freshness and innovation drives us to create daily menus that embrace the best seasonal ingredients.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="content-back">
                                                <div class="cf-inner">
                                                    <div class="inner">
                                                        ...
                                                        <p>We believe great meals start with exceptional ingredients. That's why we source the freshest produce, finest meats, and highest quality ingredients to create dishes bursting with flavor.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="content-back">
                                                <div class="cf-inner">
                                                    <div class="inner">
                                                        ...
                                                        <p>Behind every exceptional dish is a passionate and creative chef. Our team of culinary maestros brings a wealth of expertise and innovation to the kitchen.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="hero-menu_header fl-wrap">
                                            <ul class="tabs-menu     no-list-style change_bg">
                                                <li class="current"><a href="#tab-1" data-bgtab="images/bg/6.jpg"><span>01.</span>Starter</a></li>
                                                <li><a href="#tab-2" data-bgtab="images/bg/7.jpg"><span>02.</span>Desserts</a></li>
                                                <li><a href="#tab-3" data-bgtab="images/bg/5.jpg"><span>03.</span>Sea Food</a></li>
                                                <li><a href="#tab-4" data-bgtab="images/bg/9.jpg"><span>04.</span>Drinks</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!--  hero-menu_header  end-->
                                            ...
                                            <div class="tabs-container">
                                                <div class="tab">
                                                    ...
                                                    <div id="tab-1" class="tab-content first-tab">
                                                        <!-- header-menu-item-->
                                                        <?php
                                                            $sql = "SELECT * FROM products WHERE category='starter' LIMIT 3";
                                                        ...
                                                        <div class="hero-menu-item">
                                                            <div class="hero-menu-item-title fl-wrap">
                                                                <h6><span><?php echo $a;?>. </span><?php echo $row['product_name'];?></h6>
                                                                <div class="hmi-dec"></div>
                                                                <span class="hero-menu-item-price">Rs. <?php echo $row['product_price'];?></span>
                                                            </div>
                                                            <div class="hero-menu-item-details">
                                                                <p><?php echo strtok($row['description'], '.');?>.</p>
                                                            </div>
                                                        </div>
                                                        <?php
                                                            $a++;
                                                    ...
                                                    <div class="tab">
                                                        <div id="tab-2" class="tab-content">
                                                            <!-- header-menu-item-->
                                                            <?php
                                                                $sql = "SELECT * FROM products WHERE category='desserts' LIMIT 3";
                                                                $result = mysqli_query($conn, $sql);
                                                                $b=01;
                                                                if (mysqli_num_rows($result) > 0) {
                                                                // output data of each row
                                                            ...
                                                            <div class="hero-menu-item">
                                                                <div class="hero-menu-item-title fl-wrap">
                                                                    <h6><span><?php echo $b;?>. </span><?php echo $row['product_name'];?></h6>
                                                                    <div class="hmi-dec"></div>
                                                                    <span class="hero-menu-item-price">Rs. <?php echo $row['product_price'];?></span>
                                                                </div>
                                                                <div class="hero-menu-item-details">
                                                    ...
                                                    <div class="tab">
                                                        <div id="tab-3" class="tab-content">
                                                            <!-- header-menu-item-->
                                                            <?php
                                                                $sql = "SELECT * FROM products WHERE category='seafood' LIMIT 3";
                                                                $result = mysqli_query($conn, $sql);
                                                                $c=01;
                                                                if (mysqli_num_rows($result) > 0) {
                                                                // output data of each row
                                                            ...
                                                            <div class="hero-menu-item">
                                                                <div class="hero-menu-item-title fl-wrap">
                                                                    <h6><span><?php echo $c;?>. </span><?php echo $row['product_name'];?></h6>
                                                                    <div class="hmi-dec"></div>
                                                                    <span class="hero-menu-item-price">Rs. <?php echo $row['product_price'];?></span>
                                                                </div>
                                                                <div class="hero-menu-item-details">
                                                    ...
                                                    <div class="tab">
                                                        <div id="tab-4" class="tab-content">
                                                            <!-- header-menu-item-->
                                                            <?php
                                                                $sql = "SELECT * FROM products WHERE category='drinks' LIMIT 3";
                                                                $result = mysqli_query($conn, $sql);
                                                                $d=01;
                                                                if (mysqli_num_rows($result) > 0) {
                                                                // output data of each row
                                                            ...
                                                            <div class="hero-menu-item">
                                                                <div class="hero-menu-item-title fl-wrap">
                                                                    <h6><span><?php echo $d;?>. </span><?php echo $row['product_name'];?></h6>
                                                                    <div class="hmi-dec"></div>
                                                                    <span class="hero-menu-item-price">Rs. <?php echo $row['product_price'];?></span>
                                                                </div>
                                                                <div class="hero-menu-item-details">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="team-box">
                                            ...
                                            <div class="team-info fl-wrap">
                                                ...
                                                <p>Chef Sarah Rodriguez, a culinary virtuoso with a passion for creativity, brings an extensive expertise in fusion cuisine to Culinary Cove. With years of experience in renowned kitchens around the world, Chef Sarah's culinary journey has been a testament to her dedication to mastering the art of flavors. Her innovative approach and meticulous attention to detail are reflected in each dish she crafts. From blending local spices to creating unique taste combinations, Chef Sarah's creations are a celebration of culinary artistry.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- team-item  end-->
                                    ...
                                    <div class="col-md-4">
                                        <div class="team-box">
                                            ...
                                            <div class="team-info fl-wrap">
                                                ...
                                                <p>Chef Malik Ahmed, a seasoned expert in gastronomy, infuses his culinary creations with a profound understanding of traditional recipes and modern techniques. His culinary prowess and commitment to quality have earned him accolades across the culinary landscape. Chef Malik's passion for showcasing the essence of local ingredients in global cuisine is evident in every dish he meticulously prepares. His dedication to perfection and creativity adds an exceptional touch to the culinary offerings at Culinary Cove.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- team-item end  -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="team-box">
                                            ...
                                            <div class="team-info fl-wrap">
                                                ...
                                                <p>Chef Aisha Khan, known for her innovative culinary concepts, brings a fresh perspective to the table with her inventive recipes and artistic presentations. With a background rooted in diverse culinary traditions, Chef Aisha's culinary journey has been a fusion of flavors, textures, and unique culinary experiences. Her commitment to using seasonal, locally sourced ingredients shines through in her creations, offering guests a delightful gastronomic adventure.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- team-item end  -->
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                ...
                                                <div class="testimonilas-text fl-wrap">
                                                    ...
                                                    <p>
                                                        "An exceptional dining experience at Culinary Cove! The ambiance was inviting, and the staff was incredibly welcoming. The menu offered a delightful array of dishes that perfectly blended local flavors with international cuisine. I couldn't resist trying their signature dish, and it exceeded my expectations! The presentation was impeccable, and the taste was divine. A definite must-visit for anyone seeking a memorable culinary journey!"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                ...
                                                <div class="testimonilas-text fl-wrap">
                                                    ...
                                                    <p>
                                                        "My recent visit to Culinary Cove left me speechless! From the moment I stepped in, the atmosphere was charming and sophisticated. The attention to detail in their dishes was evident; each plate was a work of art. The flavors were outstanding, reflecting a perfect balance of spices and freshness. The staff was attentive and knowledgeable, making our evening even more enjoyable. Culinary Cove is a gem in Lahore's dining scene, and I can't wait to return for another culinary adventure!"
                                                    </p>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                ...
                                                <div class="testimonilas-text fl-wrap">
                                                    ...
                                                    <div class="star-rating" data-starrating="5"> </div>
                                                    <p>
                                                        "Culinary Cove is a culinary oasis in Lahore! The ambiance was elegant and inviting, setting the stage for an exceptional dining experience. The menu offered an impressive selection of dishes, and every bite was a burst of delightful flavors. Their commitment to using fresh, local ingredients was evident in the taste and quality of the food. The service was impeccable, and the staff's hospitality added to the overall charm. A top-notch restaurant that has earned its place among Lahore's finest!"
                                        ...
                                        <div class="swiper-slide">
                                            <div class="testi-item fl-wrap">
                                                ...
                                                <div class="testimonilas-text fl-wrap">
                                                    ...
                                                    <div class="star-rating" data-starrating="5"> </div>
                                                    <p>
                                                        "My visit to Culinary Cove was an absolute delight! The restaurant's ambiance exuded elegance and comfort, providing the perfect setting for an exquisite dining experience. The menu offered an impressive variety of dishes, each meticulously prepared with a blend of flavors that was nothing short of exceptional. The attention to detail was evident in every aspect, from the presentation to the taste. The staff was attentive, knowledgeable, and their recommendations elevated our dining adventure. Culinary Cove surpassed all expectations, making it a must-visit spot for anyone seeking a memorable gastronomic journey in Lahore!"
                                                    </p>
