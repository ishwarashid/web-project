        ...
        ***********************************-->
        <div class="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="form-head dashboard-head d-md-flex flex-wrap d-block mb-5 align-items-center">
					<h2 class="dashboard-title me-4">Wallet Balance<span class="text-success ms-4">$987.50</span></h2>
					<a  href="javascript:void(0);" class="btn btn-success btn-rounded me-auto mb-mb-0 mb-3 text-white d-inline-block">Send To Bank</a>
