	...
	<?php include 'includes/sidebar.php'; ?>
        ...
        <div class="content-wrapper">
			...
			<div class="container-fluid">
				<div class="form-head dashboard-head d-md-flex d-block mb-5 align-items-start">
					<h2 class="dashboard-title me-auto">Customer <a href="javascript:void(0);" class="btn btn-success btn-rounded ms-4 text-white d-inline-block flex-grow-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
					Add New
					</a></h2>
					
					<div class="input-group search-area">
						<form action="" method="post">
						<input type="text" class="form-control" name="searchedPerson" placeholder="Search here...">
						...
						<div class="table-responsive">
							<table id="example5" class="display mb-4 defaultTable dataTablesCard" style="min-width: 845px;">
								...
								if(isset($_REQUEST['searchBtn'])){
									$searchedPerson = mysqli_real_escape_string($conn,$_POST['searchedPerson']);
                                	$sql = "SELECT * FROM customers WHERE name LIKE '%$searchedPerson%';";
								} else {
        ...
        ***********************************-->
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog modal-dialog-center">
			<div class="modal-content">
				<form action="handle-new-customers.php" method="post">
