							...
							<table id="example5" class="display mb-4 defaultTable dataTablesCard" style="min-width: 845px;">
								...
								<?php 
									...
									if(!$_POST["orderStatus"]){
										$sql = "SELECT orders.order_id, orders.quantity, orders.status, products.product_name, products.product_price, products.image, customers.name
										FROM orders
                            	...
                            	?>
									<tr>
										...
										<?php if($row['status'] == 'placed'){ ?>
													<td><span class="badge bg-warning">Pending Order</span></td>
										<?php } else { ?>
										...
										<td>
											<div class="action-buttons d-flex justify-content-end">
												...
												<a href="handle-delete-item.php?id=<?php echo $row['order_id'];?>" class="btn btn-danger light">
