        ...
        <div class="content-wrapper">
			...
			<div class="container-fluid">
				<div class="form-head dashboard-head d-md-flex d-block mb-5 align-items-start">
					<h2 class="dashboard-title me-auto">Customer<a  href="javascript:void(0);" data-toggle="modal" data-target="#AddNewCustomer" class="btn btn-success btn-rounded ms-4 text-white d-inline-block">Add New</a></h2>
				...
				<!-- Modal -->
				<div class="modal booking-detail-box" id="AddNewCustomer">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form>
									<div class="form-group">
										<label class="font-w600">Full Name</label>
										<input class="form-control solid" type="text" placeholder="Enter Name" value="Jimmy Taylor">
									</div>
									<div class="form-group">
										<label class="font-w600">Email Address</label>
										<input class="form-control solid" type="email" placeholder="Enter Email" value="jimmytaylor1234@email.com">
									</div>
									<div class="form-group">
										<label class="font-w600">Phone Number</label>
										<input class="form-control solid" type="text" placeholder="Enter Number" value="+1 987 645 5432">
									</div>
							...
							<div class="modal-footer p-0 border-0 ">
								<div class="row m-0 w-100">
									<a class="btn btn-danger rounded-0 btn block col-6" href="javascript:void(0);" data-dismiss="modal">Cancel</a>
									<a class="btn btn-primary rounded-0 btn block col-6" href="javascript:void(0);">Add Expense</a>
								</div>
							</div>
						</div>
					</div>
							...
							<table id="example5" class="display mb-4 defaultTable dataTablesCard" style="min-width: 845px;">
                            	...
                            	?>
									...
									<!-- <tr>
										...
										<td>
											<div class="action-buttons d-flex justify-content-end">
												<a href="javascript:void(0);" class="btn btn-danger light me-2">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"/>
															<path d="M6,8 L6,20.5 C6,21.3284271 6.67157288,22 7.5,22 L16.5,22 C17.3284271,22 18,21.3284271 18,20.5 L18,8 L6,8 Z" fill="#000000" fill-rule="nonzero"/>
