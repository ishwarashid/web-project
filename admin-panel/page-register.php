                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="https://davur.dexignzone.com/frontend/index.html">
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" class="btn btn-primary btn-block" class="btn btn-primary btn-block" style="background-color:#292929; border: none;">Sign me up</button>
                                        </div>
                                    </form>
                                    <div class="new-account mt-3">
                                        <p>Already have an account? <a style="color:#292929; font-weight: bold;" href="page-login.php">Sign in</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
